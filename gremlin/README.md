...
| `chao.annotations`                        | Specify any arbitrary annotations to pass to the Chao deployment. | `{}`                                                                                        |
...
| `gremlin.extraAnnotations`                     | Specify any arbitrary annotations to pass to the Gremlin Agent daemonset. | `{}`                                                                                        |
